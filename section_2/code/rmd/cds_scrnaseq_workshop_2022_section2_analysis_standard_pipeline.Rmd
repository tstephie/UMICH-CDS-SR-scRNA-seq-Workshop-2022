...
# save DE table
## DO NOT RUN
# write_csv(merged_ob, 'tables/cds_pasca_example_cluster0_de_032222.csv')
...
```{r}
de <- read_csv('D:/scRNA-seq pipeline/pasca_dataset/tables/cds_pasca_example_cluster0_de_032222.csv')
